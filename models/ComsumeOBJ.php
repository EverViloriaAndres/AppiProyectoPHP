...
require_once  "../Clclientes/Obj.php";
...
switch($_SERVER['REQUEST_METHOD']){
    ...
    /*Si biene algo por url, lo uso como filtro*/
        if(isset($_GET['criterio'])){
            ...
            echo json_encode($Obj->getByCriterio($criterio),JSON_PRETTY_PRINT);
    ...
    case 'POST';
        ...
        if($datos!=NULL){
                ...
                $valor = $datos["valor"];
            $resulsInsert = $Obj->insert($nombre,$marca,$contenido,$valor);
            if($resulsInsert){
    ...
    case 'PUT';
        ...
        if ($datos != NULL) {
            ...
            $resulsUpdate = $Obj->update($id, $nombre, $marca, $contenido, $valor);
